...
// Concepts library
#include <concepts>             // (C++20) Fundamental library concept
...
#include <codecvt>              // (C++11)(deprecated in C++17)(removed in C++26)
...
#include <math.h>               // Behaves as if each name from <cmath> is placed in global namespace,
...
#include <stddef.h>             // Behaves as if each name from <cstddef> is placed in global namespace,
